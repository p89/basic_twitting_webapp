    ...
    public static function write($connection, $objArray) {
        ...
        if ($objArray) {
            foreach ($objArray as $key => $val) {
                ...
                echo '<tr><td width="320" class="maintd">Dodano przez: <a href="main.php?page=userPage&userPage='.$user . '">' . $user . '</a></td><td align="right" class="maintd"> Data: '.$val->getDate() . '</td></tr>';
